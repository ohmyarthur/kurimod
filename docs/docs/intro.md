...
[![Telegram](https://img.shields.io/badge/Telegram-2CA5E0?style=flat&logo=telegram&logoColor=white)](https://t.me/Kurimodchat)
![GitHub release (latest by date)](https://img.shields.io/github/v/release/ohmyarthur/Kurimod)
[![Downloads](https://static.pepy.tech/badge/Kurimod)](https://pepy.tech/project/Kurimod)
[![Downloads](https://static.pepy.tech/badge/Kurimod/month)](https://pepy.tech/project/Kurimod)

Kurimod is a versatile Python add-on for the Pyrogram library, designed to make developing Telegram bots faster and more
efficient.
