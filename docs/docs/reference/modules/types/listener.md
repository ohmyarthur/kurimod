...
title: Listener
---
## *class* kurimod.types.Listener

The `kurimod.types.Listener` class is designed to manage and handle different types of listeners used in kurimod. It enables
...
|-------------------------|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `listener_type`         | `kurimod.types.ListenerTypes` | The type of listener that specifies the event you want to listen for. It can be either a "message" or a "callback_query."                                                                                         |
...
| `identifier`            | `kurimod.Identifier`          | An `Identifier` instance that defines the criteria for the event. It includes properties like `chat_id`, `message_id`, `from_user_id`, and `inline_message_id` that you want to match against the incoming event. |
